 ...
 */
public class CopyOfAddIdCursorLoader extends AsyncTaskLoader<Cursor> {
     ...
     */
    public CopyOfAddIdCursorLoader(Context context) {
        super(context);
     ...
     */
    public CopyOfAddIdCursorLoader(Context context, Uri uri, String[] projection, String selection,
