 ...
 */
public class MusicRecycleViewAdapter3 extends RecyclerView.Adapter<MusicRecycleViewAdapter3.ViewHolder> {
    // 帧动画
    ...
    public MusicRecycleViewAdapter3(Context context, List<AudioInfo> lists) {
