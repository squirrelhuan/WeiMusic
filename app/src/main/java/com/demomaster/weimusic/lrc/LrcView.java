package com.demomaster.weimusic.lrc;
...
public class LrcView extends View implements ILrcView {
     ...
     **/
    private int mSeekLineTextSize = 48;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最小值
     **/
    private int mMinSeekLineTextSize = 24;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最大值
     **/
    private int mMaxSeekLineTextSize = 64;

    /**
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = 48;    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
     ...
     * 歌词字体大小最大值
     **/
    private int mMaxLrcFontSize = 64;
    ...
    public LrcView(Context context, AttributeSet attr) {
        ...
        context.getTheme().resolveAttribute(R.attr.textLight, typedValue, true);
        mHignlightRowColor = typedValue.data;
        TypedValue typedValue2 = new TypedValue();
        context.getTheme().resolveAttribute(R.attr.textLight2, typedValue2, true);
        mNormalRowColor = typedValue2.data;
    }
